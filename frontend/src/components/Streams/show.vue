        ...
        <div class="col-md-6 chat-box-wrapper">
          <div class="chat-box">
            ...
            <div class="input-group mb-3 chat-input">
              <input v-model='inputMessage' type="text" class="form-control" placeholder="Chat here" aria-label="Username" aria-describedby="basic-addon1">
              <div class="input-group-prepend">
                <button class="btn btn-primary" id="basic-addon1" @click='handleMessageSend()'>Send</button>
              </div>
            </div>
          </div>
        </div>
